...
> Referencia exclusiva para BIA (agente supervisora). Padroes de orquestracao multi-agente e boas praticas. Extraido e adaptado de skills MIT (aitmpl.com).
...
Aplicacao Bia: Ao receber uma tarefa complexa (ex: "preparar campanha completa"), Bia deve:
...
Aplicacao Bia: Para campanhas multi-canal:
...
5. Bia revisa o conjunto e verifica consistencia
...
### Escalonamento
Quando Bia deve escalar para humano:
...
5. **Bia nao executa**: Bia orquestra, nao faz o trabalho operacional
