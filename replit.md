...
- **Support Chat:** Implements a chat interface for providers to communicate with administrators, with separate polling mechanisms for provider and admin sides.
