  ...
  return <form onSubmit={e => { e.preventDefault(); salvar.mutate(); }} className="space-y-4">
    ...
    <div className="grid gap-4 md:grid-cols-2">
      <fieldset disabled={desabilitado} className="rounded-lg border p-4 space-y-3">
        ...
        <p className="text-xs text-muted-foreground">{consulta.data?.sms.recebimentoConfigurado ? "Recebimento configurado aqui; confirme também a URL no painel Twilio. Respostas de clientes identificados entram no chat." : "Sem a URL configurada aqui e na Twilio, o canal permite apenas envio."}</p>
      </fieldset>
      <fieldset disabled={desabilitado} className="rounded-lg border p-4 space-y-3">
