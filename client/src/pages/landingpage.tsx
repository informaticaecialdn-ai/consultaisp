...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden" data-testid="landing-page">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/60 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-500">
            <button onClick={() => document.getElementById("como-funciona")?.scrollIntoView({ behavior: "smooth" })} className="hover:text-slate-900 transition-colors" data-testid="nav-como-funciona">Como funciona</button>
            <button onClick={() => document.getElementById("funcionalidades")?.scrollIntoView({ behavior: "smooth" })} className="hover:text-slate-900 transition-colors" data-testid="nav-funcionalidades">Funcionalidades</button>
            <button onClick={() => document.getElementById("planos")?.scrollIntoView({ behavior: "smooth" })} className="hover:text-slate-900 transition-colors" data-testid="nav-planos">Planos</button>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Button className="bg-slate-900 hover:bg-slate-800 text-white text-sm h-9 gap-1.5" onClick={goLogin} data-testid="button-landing-cadastro">
              Criar Conta Gratis
            </Button>
          </div>
        </div>
      ...
      <section className="relative bg-gradient-to-b from-slate-50 to-white pt-16 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-slate-200/40 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-1/4 w-80 h-80 bg-stone-200/30 rounded-full blur-3xl" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-slate-100 border border-slate-200 text-slate-600 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 leading-[1.1] tracking-tight" data-testid="text-hero-title">
                A base de dados
                <span className="text-slate-500"> compartilhada </span>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <Button size="lg" className="bg-slate-900 hover:bg-slate-800 text-white px-8 gap-2 h-12 text-base font-bold" onClick={goLogin} data-testid="button-hero-cta">
                  Criar Conta Gratis
            ...
            <div className="relative hidden lg:block">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3">
                      <p className="text-[10px] text-emerald-600 font-semibold uppercase">Seu Provedor</p>
                      ...
                      <span className="inline-block mt-2 text-[10px] bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded font-semibold">Gratuita</span>
                    </div>
                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-3">
                      ...
                      <span className="inline-block mt-2 text-[10px] bg-slate-200 text-slate-600 px-1.5 py-0.5 rounded font-semibold">1 Credito</span>
                    </div>
                  </div>
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-slate-900 rounded-2xl flex items-center justify-center shadow-xl opacity-90">
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 text-slate-500 text-xs font-bold uppercase tracking-widest mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className={`${item.bg} rounded-2xl p-6 border border-slate-200 hover:shadow-lg transition-all group`} data-testid={`shared-db-${i}`}>
                <div className={`w-12 h-12 rounded-xl ${item.accent} flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform`}>
          ...
          <div className="mt-12 bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
              ...
              <div className="lg:col-span-3 flex items-center justify-center gap-3 flex-wrap">
                {[
                  { label: "Provedor A", sub: "importa inadimplentes", color: "bg-slate-800" },
                  { label: "Base compartilhada", sub: "dados anonimizados", color: "bg-slate-900" },
                  { label: "Provedor B", sub: "consulta CPF", color: "bg-slate-700" },
                ].map((step, i) => (
      ...
      <section id="como-funciona" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-0">
            {[
              { n: "1", title: "Cadastre e importe", desc: "Crie sua conta gratuitamente, conecte seu ERP (IXC, SGP, MK Solutions) e importe sua base de inadimplentes automaticamente.", icon: Building2, color: "bg-slate-800" },
              { n: "2", title: "Consulte o CPF/CNPJ", desc: "Antes de ativar um novo cliente, consulte na base compartilhada. Receba score, alertas de fraude e sugestao de decisao em segundos.", icon: Search, color: "bg-slate-700" },
      ...
      <section id="funcionalidades" className="py-20 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { icon: Search, title: "Consulta ISP", desc: "Consulte CPF/CNPJ na base compartilhada de provedores. Historico de pagamentos, equipamentos e restricoes.", color: "bg-slate-800" },
              { icon: BarChart3, title: "Score de Credito", desc: "Score de 0 a 100 baseado em atrasos, valores, equipamentos e historico em multiplos provedores.", color: "bg-emerald-600" },
              { icon: Shield, title: "Anti-Fraude", desc: "Alertas em tempo real quando seus inadimplentes sao consultados por outros provedores.", color: "bg-red-500" },
              { icon: Flame, title: "Mapa de Calor", desc: "Visualizacao geografica das areas com maior concentracao de inadimplencia na sua regiao.", color: "bg-orange-500" },
              { icon: Bot, title: "Analise com IA", desc: "Inteligencia artificial gera recomendacoes personalizadas para cada consulta realizada.", color: "bg-indigo-500" },
              ...
              { icon: Globe, title: "Integracao com ERP", desc: "Conecte IXC, SGP ou MK Solutions e mantenha a base atualizada automaticamente.", color: "bg-cyan-600" },
              ...
              { icon: TrendingUp, title: "Relatorios e Dashboards", desc: "Indicadores de inadimplencia, volume de consultas, creditos e distribuicao de risco.", color: "bg-purple-500" },
            ].map((f, i) => (
              <div key={i} className="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md transition-all group" data-testid={`feature-${i}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className={`relative rounded-2xl border-2 p-6 ${plan.popular ? "border-slate-900 bg-slate-50 shadow-xl" : "border-slate-200 bg-white"}`} data-testid={`plan-${i}`}>
                {plan.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="bg-slate-900 text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg flex items-center gap-1">
                ...
                <Button
                  className={`w-full h-11 font-bold ${plan.popular ? "bg-slate-900 hover:bg-slate-800 text-white" : "bg-slate-100 hover:bg-slate-200 text-slate-900"}`}
                  onClick={goLogin}
      ...
      <section className="py-20 bg-slate-100 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/3 w-96 h-96 bg-slate-200/50 rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/3 w-80 h-80 bg-stone-200/40 rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="bg-slate-900 hover:bg-slate-800 text-white px-10 gap-2 h-12 text-base font-bold" onClick={goLogin} data-testid="button-cta-bottom">
              Criar Conta Gratis
              <ArrowRight className="w-4 h-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-slate-300 text-slate-600 px-8 gap-2 h-12 text-base" onClick={goLogin} data-testid="button-login-bottom">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-slate-900 font-bold">Consulta ISP</span>
